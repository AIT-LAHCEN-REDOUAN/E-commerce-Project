...
export default function Sac_Ordinateur_Portable() {
    ...
    useEffect(() => {
        fetch('http://127.0.0.1:8000/api/produit/Sac Ordinateur Portable')
            .then(res => res.json())
            .then(response => {
                ...
                <div className='col-3 col-sm-3 col-md-3 col-lg-3 mt-5'>
                    ...
                    <div className='row'>
                        <div className='col-12 col-sm-12 col-md-12 col-lg-12 mt-5'>
                            <div className='card rounded rounded-3'>
                                <div className='card-header'>
                                    <h4 className='fw-bold m-1 p-1' style={{ fontSize: '1.2vw' }}>BRANDS</h4>
                                </div>
                                <div className='card-body'>
                                        ...
                                        marque.map((ele,i) => {
                                            return (
                                                <div className='d-flex p-2 m-1' key={i}>
                                                    <input type='radio' name='brand' className='form-check-input m-1' value={ele.marque} onClick={(e) => { setBrand(e.target.value) }} />
                                                    <label className='ms-2' style={{ fontSize: "1.1vw", fontWeight: "500" }}>{ele.marque}</label>
                                                </div>
                                            )
                                        })
                                    }
